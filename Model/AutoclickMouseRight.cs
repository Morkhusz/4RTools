...
{
    public class AutoclickMouseRight : Action
    {
        private const string ACTION_NAME = "AutoclickMouseRight";
        ...
        private int AutoclickThreadExecution(Client roClient)
        {
            ...
            {
                // Send right mouse button down and up messages
